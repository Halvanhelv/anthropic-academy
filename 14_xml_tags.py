...
"""
    ...
    def run_evaluation(self, run_prompt_function, dataset_file, extra_criteria=None,
                       json_output_file="14_xml_tags_output/output.json", html_output_file="14_xml_tags_output/output.html"):
...
dataset = evaluator.generate_dataset(
    ...
    output_file="14_xml_tags_output/meal_plan_dataset.json",
    num_cases=3,
)
...
results = evaluator.run_evaluation(
    ...
    dataset_file="14_xml_tags_output/meal_plan_dataset.json",
    extra_criteria="""
