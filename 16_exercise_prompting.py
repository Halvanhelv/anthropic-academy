...
class PromptEvaluator:
    ...
    def generate_dataset(self, task_description, prompt_inputs_spec, num_cases=4, output_file="dataset.json"):
...
"""
    ...
    def run_evaluation(self, run_prompt_function, dataset_file, extra_criteria=None,
                       json_output_file="16_exercise_prompting_output/output.json",
                       html_output_file="16_exercise_prompting_output/output.html"):
...
import os
if not os.path.exists("16_exercise_prompting_output/dataset.json"):
    dataset = evaluator.generate_dataset(
        ...
        output_file="16_exercise_prompting_output/dataset.json",
        num_cases=4,
    )
...
results = evaluator.run_evaluation(
    ...
    dataset_file="16_exercise_prompting_output/dataset.json",
    extra_criteria="""
